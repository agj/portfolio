	...
	Mediabox = {
		...
		open: function(_images, startImage, _options) {
			options = $extend({
				...
				initialWidth: 300,				// Initial width of the box (in pixels)
				initialHeight: 300,				// Initial height of the box (in pixels)
				defaultWidth: 400,				// Default width of the box (in pixels) for undefined media (MP4, FLV, etc.)
				defaultHeight: 302,				// Default height of the box (in pixels) for undefined media (MP4, FLV, etc.)
...
//			Global media options
				scriptaccess: 'false',		// Allow script access to flash files
